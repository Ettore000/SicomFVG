<html>
    <head>
        <!--Titolo-->
        <title>Sicom DB - Codice QR</title>
    ...
    <body>
        ...
        <?php
            if ($_GET["apposto"] > 0) {
                header("location: http://sicomdata.eu5.org/");
            } else {
                ...
                // Richiesta
                $sql = "DELETE FROM " . $_GET["dispositivo"] . " WHERE " . $_GET["dispositivo"] . ".Matricola = " . $_GET["matricola"] . "";
        ...
        <div align="center">
            ...
            <script>
                function vabbene() {
                  window.location.replace("https://sicomdata.eu5.org/codiceqr/crea/crea.php");
                }
            </script>
        </div>
        </font>
